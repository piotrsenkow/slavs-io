...
function About() {
  ...
  <div class="section-about ">
    <div class="about-page-content relative flex flex-col items-start">
      ...
      <div class="text-white absolute w-screen flex items-center justify-center px-8">
        <div class="grid grid-cols-1 gap-y-10">
          <div class="pt-10 sm:pt-20">
            <p class="bold pl-4 text-3xl leading-9 font-bold sm:text-4xl sm:w-2/5">13+ Countries, 120+ Attributes, 10000 Slavs. Collect &amp; hold your part of the internet's first Slav Squat collection. </p>
          </div>
          <div class="teaser-stats text-white flex p-4">
            <div class="box pr-3 border-r-2">
              <div class="feature ext-black mb-1.5 text-xl font-black">10,000</div>
              <p class="sub font-thin">slavs</p>
            </div>
            <div class="box pr-3 pl-3 border-r-2">
              <div class="feature ext-black mb-1.5 text-xl font-black">DEC 2021</div>
              <p class="sub font-thin">launch</p>
            </div>
            <div class="box-last pl-3">
              <div class="feature ext-black mb-1.5 text-xl font-black">TBD</div>
