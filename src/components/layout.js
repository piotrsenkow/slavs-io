...
const Layout = ({ children }) => {
  ...
  const navigation = [
    {
      name: 'Discord',
      href: 'https://www.discord.gg/squattingslavs',
      icon: (props) => (
    ...
    {
      name: 'Twitter',
      href: 'https://www.twitter.com/slavicnfts',
      icon: (props) => (
  ...
  return (
    <>
      ...
      <div class="h-screen"> 
        <main>{children}</main>
        <footer className="bg-black relative bottom-0 font-mono">
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
            <div className="flex justify-center space-x-6 md:order-2 text-white">
              {navigation.map((item) => (
